...
curl_check "Root/static site" "https://$DOMAIN/"
curl_check "Auth portal health" "https://auth.$DOMAIN/_auth/health"
curl_check "Flask API" "https://api.$DOMAIN/"
curl_check "Flask+Redis API" "https://redis-api.$DOMAIN/"
curl_check "Node.js API" "https://node.$DOMAIN/"
curl_check "Uptime Kuma" "https://status.$DOMAIN/"
curl_check "FileBrowser" "https://files.$DOMAIN/"
curl_check "VUI blog" "https://vui.$DOMAIN/"
curl_check "Authenticated VUI blog" "https://blog-auth.$DOMAIN/"
curl_check "SvelteKit blog" "https://svelte.$DOMAIN/"
curl_check "C# API" "https://csharp.$DOMAIN/"
curl_check "Go API" "https://go.$DOMAIN/"
curl_check "Rust API" "https://rust.$DOMAIN/"
